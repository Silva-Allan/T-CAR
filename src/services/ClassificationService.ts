...
const CLASSIFICATION_TABLES: Record<1 | 2, { maxPV: number; label: string; percentile: number; color: string }[]> = {
    1: [
        { maxPV: 10.0, label: 'classVeryWeak', percentile: 5, color: '#EF4444' },
        { maxPV: 11.0, label: 'classWeak', percentile: 15, color: '#F97316' },
        { maxPV: 12.0, label: 'classBelowAverage', percentile: 30, color: '#F59E0B' },
        { maxPV: 13.5, label: 'classAverage', percentile: 50, color: '#EAB308' },
        { maxPV: 15.0, label: 'classGood', percentile: 70, color: '#84CC16' },
        { maxPV: 16.5, label: 'classVeryGood', percentile: 85, color: '#22C55E' },
        { maxPV: 18.0, label: 'classExcellent', percentile: 95, color: '#006633' },
        { maxPV: Infinity, label: 'classElite', percentile: 99, color: '#006633' },
    ],
    2: [
        { maxPV: 13.0, label: 'classVeryWeak', percentile: 5, color: '#EF4444' },
        { maxPV: 14.0, label: 'classWeak', percentile: 15, color: '#F97316' },
        { maxPV: 15.0, label: 'classBelowAverage', percentile: 30, color: '#F59E0B' },
        { maxPV: 16.5, label: 'classAverage', percentile: 50, color: '#EAB308' },
        { maxPV: 18.0, label: 'classGood', percentile: 70, color: '#84CC16' },
        { maxPV: 19.5, label: 'classVeryGood', percentile: 85, color: '#22C55E' },
        { maxPV: 20.5, label: 'classExcellent', percentile: 95, color: '#006633' },
        { maxPV: Infinity, label: 'classElite', percentile: 99, color: '#006633' },
    ],
};
